...
print(f'recebendo o salario de {salarioJoao}, tendo o valor da conta 1 com o atraso sendo {(c1 * 0.02)+c1}\nTendo a conta 2 com o atraso sendo {(c2 * 0.02)+c2}\nO restante do salario sera de {} ')